...
yes<-sample(vraT_expression_level, 500, replace=FALSE, prob = ifelse(trait_of_interest>0, 1, 0)) #### play with this line! Is the test statistically significant. When is it not?
...
Answer-A two sample test would be comparing two mutant strains on *S. aureus*. One sample t-test would compare any mutant strain with the wild type strain.
