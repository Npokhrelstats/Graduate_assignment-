...
I will be working on protein expression in *Staphylococcus aureus* to decipher how it would effect antibiotic resistance   
```# Simulate VrAT protein expression levels in Staphylococcus aureus
rnorm(1000, mean = 10, sd = 1) -> VrAT_expression # Adjust the mean and standard deviation based on typical expression levels

# Plot the density of VrAT protein expression levels
plot(density(VrAT_expression), main = "VrAT Protein Expression in Staphylococcus aureus", xlab = "Protein Expression Level", ylab = "Density")

# Get the minimum and maximum expression levels
min(VrAT_expression)
max(VrAT_expression)
